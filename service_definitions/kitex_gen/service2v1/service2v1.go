...
type MulResponse struct {
	Product int64 `thrift:"product,1" frugal:"1,default,i64" json:"product"`
}
...
func (p *MulResponse) GetProduct() (v int64) {
	return p.Product
}
func (p *MulResponse) SetProduct(val int64) {
	p.Product = val
}
...
func (p *MulResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("product", thrift.I64, 1); err != nil {
		goto WriteFieldBeginError
	}
