...
func (p *SubRequest) GetFirst() (v int64) {
	return p.First
}

func (p *SubRequest) GetSecond() (v int64) {
	return p.Second
}
func (p *SubRequest) SetFirst(val int64) {
	p.First = val
}
func (p *SubRequest) SetSecond(val int64) {
	p.Second = val
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_SubRequest[fieldId]))
}
...
func (p *SubRequest) Field1DeepEqual(src int64) bool {
...
func (p *SubRequest) Field2DeepEqual(src int64) bool {
...
type SubResponse struct {
	Diff int64 `thrift:"diff,1" frugal:"1,default,i64" json:"diff"`
}
...
func (p *SubResponse) GetDiff() (v int64) {
	return p.Diff
}
func (p *SubResponse) SetDiff(val int64) {
	p.Diff = val
}
...
func (p *SubResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("diff", thrift.I64, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI64(p.Diff); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *SubResponse) DeepEqual(ano *SubResponse) bool {
	...
	if !p.Field1DeepEqual(ano.Diff) {
		return false
	}
	return true
}

func (p *SubResponse) Field1DeepEqual(src int64) bool {
...
func (p *Service1Client) Sub(ctx context.Context, req *SubRequest) (r *SubResponse, err error) {
	var _args Service1SubArgs
	_args.Req = req
	var _result Service1SubResult
...
func NewService1Processor(handler Service1) *Service1Processor {
	...
	self.AddToProcessorMap("Sub", &service1ProcessorSub{handler: handler})
	return self
}
...
type service1ProcessorSub struct {
	handler Service1
}

func (p *service1ProcessorSub) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := Service1SubArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
type Service1SubArgs struct {
	Req *SubRequest `thrift:"req,1" frugal:"1,default,SubRequest" json:"req"`
}

func NewService1SubArgs() *Service1SubArgs {
	return &Service1SubArgs{}
}

func (p *Service1SubArgs) InitDefault() {
	*p = Service1SubArgs{}
}

var Service1SubArgs_Req_DEFAULT *SubRequest

func (p *Service1SubArgs) GetReq() (v *SubRequest) {
	if !p.IsSetReq() {
		return Service1SubArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *Service1SubArgs) SetReq(val *SubRequest) {
	p.Req = val
}

var fieldIDToName_Service1SubArgs = map[int16]string{
	1: "req",
}

func (p *Service1SubArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *Service1SubArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_Service1SubArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *Service1SubArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewSubRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
...
func (p *Service1SubArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *Service1SubArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *Service1SubArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("Service1SubArgs(%+v)", *p)
}

func (p *Service1SubArgs) DeepEqual(ano *Service1SubArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *Service1SubArgs) Field1DeepEqual(src *SubRequest) bool {
...
type Service1SubResult struct {
	Success *SubResponse `thrift:"success,0,optional" frugal:"0,optional,SubResponse" json:"success,omitempty"`
}

func NewService1SubResult() *Service1SubResult {
	return &Service1SubResult{}
}

func (p *Service1SubResult) InitDefault() {
	*p = Service1SubResult{}
}

var Service1SubResult_Success_DEFAULT *SubResponse

func (p *Service1SubResult) GetSuccess() (v *SubResponse) {
	if !p.IsSetSuccess() {
		return Service1SubResult_Success_DEFAULT
	}
	return p.Success
}
func (p *Service1SubResult) SetSuccess(x interface{}) {
	p.Success = x.(*SubResponse)
}

var fieldIDToName_Service1SubResult = map[int16]string{
	0: "success",
}

func (p *Service1SubResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *Service1SubResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_Service1SubResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *Service1SubResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *Service1SubResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *Service1SubResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *Service1SubResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("Service1SubResult(%+v)", *p)
}

func (p *Service1SubResult) DeepEqual(ano *Service1SubResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *Service1SubResult) Field0DeepEqual(src *SubResponse) bool {
